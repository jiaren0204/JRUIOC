...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/jiaren0204/JRUIOC.git", :tag => "0.0.6" }

  s.source_files  = "JRUIOC/Classes/JRUIOC.h"

  s.subspec 'JRTableViewManager' do |ss|
    table.source_files = 'JRUIOC/Classes/JRTableViewManager/*.{h,m}'
  end
